...
import { Download, Play, Pause, Volume2, VolumeX, Maximize, Minimize, Share2 } from "lucide-react"
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Preview your video below or download it to share with your audience</CardDescription>
      </CardHeader>
